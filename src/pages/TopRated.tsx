...
import { sortByTopRated } from '@/lib/videoSorting';
...
const TopRated = () => {
  ...
  const sorted = useMemo(() => sortByTopRated(videos), [videos]);
      ...
      <div className="max-w-[1600px] mx-auto pt-8 px-4 md:px-8 flex gap-6">
        <div className="flex-1">
          <div className="mb-4">
            ...
            <p className="text-muted-foreground">Sorted by rating score & likes</p>
          </div>
          <VideoGrid videos={sorted} onVideoClick={setSelectedVideo} title="⭐ TOP RATED" perPage={20} />
        </div>
