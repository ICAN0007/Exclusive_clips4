...
import { sortByPopularity } from '@/lib/videoSorting';
...
const Popular = () => {
  ...
  const sorted = useMemo(() => sortByPopularity(videos), [videos]);
      ...
      <div className="max-w-[1600px] mx-auto pt-8 px-4 md:px-8 flex gap-6">
        <div className="flex-1">
          <div className="mb-4">
            ...
            <p className="text-muted-foreground">Popularity score: 40% views + 35% likes + 25% comments</p>
          </div>
          <VideoGrid videos={sorted} onVideoClick={setSelectedVideo} title="📈 POPULAR" perPage={20} />
        </div>
