...
import { sortByNewest } from '@/lib/videoSorting';
...
const NewReleases = () => {
  ...
  const sorted = useMemo(() => sortByNewest(videos), [videos]);
    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-[1600px] mx-auto pt-8 px-4 md:px-8 flex gap-6">
        <div className="flex-1">
          <div className="mb-4">
            <h1 className="text-4xl md:text-5xl font-black gradient-text mb-2">⏰ New Releases</h1>
            <p className="text-muted-foreground">Sorted by upload date — newest first</p>
          </div>
          <VideoGrid videos={sorted} onVideoClick={setSelectedVideo} title="⏰ NEW RELEASES" perPage={20} />
        </div>
